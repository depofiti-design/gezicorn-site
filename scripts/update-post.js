...
// Güncellenebilir alanlar: title, excerpt, content, category, cover_image, cover_alt, seo_description, noindex, published
...
const ALLOWED = ['title', 'excerpt', 'content', 'category', 'cover_image', 'cover_alt', 'seo_description', 'noindex', 'published'];
